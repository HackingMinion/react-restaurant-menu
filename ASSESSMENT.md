# Documentation for a step-by-step restaurant menu in React
...
Using [PostCSS Normalize](https://github.com/csstools/postcss-normalize) to normalize browser
...
- Select 0 items
- Select 1 item each
- Select 0-2 items each
- Select all items

- Skip a step
- Go back a step
- Use navigation to skip a step
- Use navigation to go back a step
